...
export default function PmIntro() {
  return (
    <div className="w-full sm:w-[75.8125rem] flex flex-col justify-center items-center sm:items-start gap-[1.25rem]  sm:gap-[2.38rem] mt-[2.31rem] mb-[1.25rem] sm:mb-[2.37rem] ">
...
About the PM Part`}
        ...
        <div className="w-[35.1875rem] typo-small2 text-text sm:hidden">
